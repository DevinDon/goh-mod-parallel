...
export const generateBulletParameter = (bullet: WeaponBulletOptions) => {
  ...
  ${damageToHuman}
  {Spreading
    {RadiusTable {0 0} {${toFixed(effectiveRange)} ${toFixed(bullet.spreading.radiusTable.nearest)}} {${toFixed(aimRange / 2)} ${toFixed(bullet.spreading.radiusTable.farthest)}} {${toFixed(maxRange)} ${toFixed(bullet.spreading.radiusTable.farthest * (bullet.spreading.radiusTable.factor ?? 10))}}} ; 散布
