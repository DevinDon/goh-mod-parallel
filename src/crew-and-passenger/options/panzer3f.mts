...
const options: CrewAndPassengerOptions = {
  ...
  destination: `${ProjectModConfigDir}/19-germany/resource/entity/-vehicle/germany/tank_medium/panzer3f/crew-and-passenger.ext`,
