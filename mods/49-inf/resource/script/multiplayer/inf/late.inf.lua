Purchases["late.inf"] = {
  {
    ...
    Units = {
      ...
      {priority = 1.0, type = {"Class3", "Infantry", "Team",}, unit = "engineer-squad(inf)"},
      {priority = 1.0, type = {"Class3", "Infantry", "Team",}, unit = "medic-squad(inf)"},
      {priority = 2.0, type = {"Class3", "Infantry", "Team",}, unit = "sniper-squad(inf)"},
      {priority = 2.0, type = {"Class3", "Infantry", "Team",}, unit = "machine-gun-squad(inf)"},
      {priority = 2.0, type = {"Class3", "Infantry", "Team",}, unit = "antiarmor-squad(inf)"},
      {priority = 2.0, type = {"Class3", "Infantry", "Team",}, unit = "officer-squad(inf)"},
      -- 排
      {priority = 2.0, type = {"Class1", "Infantry", "Squad",}, unit = "assault-platoon(inf)"},
      {priority = 2.0, type = {"Class1", "Infantry", "Squad",}, unit = "supply-platoon(inf)"},
      {priority = 2.0, type = {"Class1", "Infantry", "Squad",}, unit = "defence-platoon(inf)"},
