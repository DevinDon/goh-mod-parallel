...
{from "pattern gun"
  ...
  {SpreadTolerance 10%} ; 瞄准到一定精度就可以开火
  ...
  {Parameters "ap"
    ...
    {Spreading
      {RadiusTable {0 0} {10 0.3} {500 1.7} {1000 5.95}} ; 散布
  ...
  {Parameters "apcr"
    ...
    {Spreading
      {RadiusTable {0 0} {10 0.2} {500 1.5} {1000 4.50}} ; 散布
      {BurstRecoveryTime 0.1} ; 开火后恢复到正常精度的时间
      {BurstAccuracy     100} ; 默认值为 100, 连续开火第一发的精度为 100%, 值越低精度越低
      {SpreadPower       1.25} ; 默认值为 1, 大于 1 时炮弹落点会偏向中心, 小于 1 时炮弹落点会远离中心
      {SpreadXYRatio     0.75} ; 默认值为 0.75 炮弹落点的横纵向比例, 小于 1 时更偏向于纵向落点, 大于 1 时更偏向于横向落点
  ...
  {Parameters "he"
    ...
    ; 无穿透伤害配置
    {Spreading
      {RadiusTable {0 0} {10 0.4} {500 2.5} {1000 10.00}} ; 散布
      {BurstRecoveryTime 0.1} ; 开火后恢复到正常精度的时间
      {BurstAccuracy     100} ; 默认值为 100, 连续开火第一发的精度为 100%, 值越低精度越低
